...
class SubscriptionBuilder
{
    ...
    public function create($token = null, array $options = [])
    {
        ...
        return $this->owner->subscriptions()->create([
            ...
            'ends_at' => null,
            'subscription_from' => Carbon::createFromTimestamp($subscription->current_period_start),
            'subscription_to' => Carbon::createFromTimestamp($subscription->current_period_end)
        ]);
    }
