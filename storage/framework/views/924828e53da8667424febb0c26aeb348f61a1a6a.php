  ...
  <aside class="main-sidebar" style="background-image: url(<?php echo e(asset('images/sidebar-7.jpg')); ?>);">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if(Auth::user()->is_assistant != 1): ?>
          <li><a class="<?php echo e(Nav::isRoute('addedmovies')); ?>" href="<?php echo e(route('addedmovies')); ?>" title="Movies"><i class="material-icons">ondemand_video</i> <span>Added Movies</span></a></li>
        <?php endif; ?>
          ...
          <?php if(Auth::user()->is_assistant != 1): ?>
          <li><a class="<?php echo e(Nav::isRoute('addedLiveTv')); ?>" href="<?php echo e(route('addedLiveTv')); ?>" title="Live TV"><i class="material-icons">shop_two</i> <span>Added LiveTv</span></a></li>
          <?php endif; ?>
        ...
        <?php if(Auth::user()->is_assistant != 1): ?>
          <li><a class="<?php echo e(Nav::isRoute('addedTvSeries')); ?>" href="<?php echo e(route('addedTvSeries')); ?>" title="Movies"><i class="material-icons">ondemand_video</i> <span>Added TV Series</span></a></li>
        <?php endif; ?>
        <?php if(Auth::user()->is_assistant != 1): ?>
...
<p class="version">Version 2.7.0&emsp;</p>
<!-- /.content-wrapper -->
<!-- Main Footer -->
