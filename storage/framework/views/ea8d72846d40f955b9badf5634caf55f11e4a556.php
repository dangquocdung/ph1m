              ...
              <div class="full-movie-dtl-block">
                ...
                ?>
                 <h6><?php echo e($header_translations->where('key', 'average rating') ? $header_translations->where('key', 'average rating')->first->value->value : ''); ?>   <span style="margin-left: 10px;"><?php echo e(number_format($avg_rating, 2)); ?></span></h6>
                    <?php echo Form::open(['method' => 'POST', 'id'=>'mformrating', 'action' => 'UserRatingController@store']); ?>
                  ...
                  <input id="rating" name="rating" class="rating rating-loading" data-min="0" data-max="5" data-step="0.1" onmouseover ="mouseoverrating()" 
              ...
              <div class="full-movie-dtl-block">
                ...
                ?>
                 <h6><?php echo e($header_translations->where('key', 'average rating') ? $header_translations->where('key', 'average rating')->first->value->value : ''); ?>   <span style="margin-left: 10px;"> <?php echo e(number_format($avg_rating, 2)); ?></span></h6>
                  ...
                  <input type="text" hidden="" name="tv_id" value="<?php echo e($season->tvseries->id); ?>">
                    <input type="text" hidden="" name="user_id" value="<?php echo e($auth->id); ?>">
                      ...
                      <div class="modal-dialog modal-md" style="margin-top:70px;">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body text-center">
                              ...
                              <form action="<?php echo e(route('tv.comment.reply', ['cid' =>$comment->id,'bid'=> $season->tvseries->id])); ?>" method ="POST">
                      ...
                      <div class="modal-dialog modal-md" style="margin-top:70px;">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body text-center">
                              ...
                              <form action="<?php echo e(route('movie.comment.reply', ['cid' =>$comment->id,'bid'=> $movie->id])); ?>" method ="POST">
                                <?php echo e(csrf_field()); ?>
