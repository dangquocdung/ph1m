    ...
    <div class="upload-image-main-block" style="display: none;">
      ...
      <div class="form-group<?php echo e($errors->has('selecturl') ? ' has-error' : ''); ?>">
        ...
        <?php echo Form::select('selecturl', array('iframeurl' => 'IFrame URL', 
           ...
           'customurl'=>'Custom URL/ Youtube URL/ Vimeo URL','multiqcustom' => 'Multi Quality Custom URL'), null, ['class' => 'form-control select2','id'=>'selecturl']); ?>
                ...
                <tr>
                  ...
                  <td>
                    <div class="admin-table-action-block side-table-action">
                      <a href="<?php echo e(route('edit_episodes',['id'=>$season->id,'ep_id'=>$episode->id])); ?>" data-toggle="tooltip" data-original-title="Edit" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
